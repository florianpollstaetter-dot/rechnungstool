...
import { getCustomers, getSettings, getActiveProducts, createInvoice } from "@/lib/db";
    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex gap-3">
          ...
          <button type="button" onClick={() => router.push("/invoices")} className="bg-[var(--surface-hover)] text-gray-300 px-4 py-2 rounded-lg text-sm font-medium hover:bg-[var(--border)] transition">
            Abbrechen
          </button>
        </div>
      </form>
