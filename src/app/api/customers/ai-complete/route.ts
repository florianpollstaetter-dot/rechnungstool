...
const CUSTOMER_FIELDS: AiCompleteFieldSpec[] = [
  ...
  { key: "country", label: "Land", description: "Land ausgeschrieben (z.B. Österreich, Deutschland)", required: true },
...

{
  ...
  "zip": "PLZ",
  "city": "Stadt",
  "country": "Land (z.B. Österreich, Deutschland)",
  ...
  try {
    ...
    return Response.json({
      ...
      customer: {
        ...
        country: result.values.country || "Österreich",
