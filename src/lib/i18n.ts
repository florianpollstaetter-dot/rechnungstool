...
const translations = {
  ...
  aboutUsTitle: { de: "Immersive Erlebnisse für Marken.", en: "Immersive experiences for brands." },
  aboutUsBody: { de: "VR the Fans GmbH ist Österreichs führender Spezialist für immersive Produktpräsentationen mit Apple Vision Pro. Wir verwandeln Produkte, Marken und Räume in unvergessliche Erlebnisse \u2013 für Messen, Events und Sales-Präsentationen.", en: "VR the Fans GmbH is Austria\u2019s leading specialist for immersive product presentations with Apple Vision Pro. We transform products, brands and spaces into unforgettable experiences \u2013 for trade shows, events and sales presentations." },
