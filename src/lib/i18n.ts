...
const translations = {
  ...
  validUntil: { de: "Gueltig bis", en: "Valid until" },
  ...
  validityNote: { de: "Dieses Angebot ist gueltig bis {date}. Bei Fragen stehen wir Ihnen gerne zur Verfuegung.", en: "This quote is valid until {date}. Please don\u2019t hesitate to contact us with any questions." },
...
const factsDE = [
  ...
  "Probleme sind verkleidete Moeglichkeiten.",
  ...
  "In der Mitte der Schwierigkeit liegt die Moeglichkeit.",
