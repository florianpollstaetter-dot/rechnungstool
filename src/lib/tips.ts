...
export const APP_TIPS: string[] = [
  ...
  "AI-Firmen-Setup: Beim Anlegen einer Firma schlägt die AI branchenspezifische Rollen vor.",
  "Du kannst Rechnungen direkt als PDF exportieren — inklusive deinem Firmenlogo und Begleittext.",
